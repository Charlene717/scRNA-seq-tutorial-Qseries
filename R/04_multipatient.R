...
#
## >>> 參考答案 ------------------------------------------------------
# 本課的結果（實跑驗證，加權平均病人熵。上限：等量時 log(4) = 1.386，
# 但照本資料的病人比例（488/1,157/1,511/383）實際可達的是 -Σp·lnp = 1.24）：
...
#
## >>> 參考答案 ------------------------------------------------------
# 本課的結果（各型別的 LISI 中位數，實跑驗證。可達上限 1/Σp² = 3.13，不是病人數 4）：
...
#   整合後惡性的熵 1.09，佔可達上限 1.24 的 88% —— 用可達上限來看，「被混掉」比對照 1.386 時更明顯。
