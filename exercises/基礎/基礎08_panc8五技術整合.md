...
- 整合的兩難在腫瘤資料會更兇險（病人間差異可能是生物訊號），見進階題的任何一份多病人腫瘤資料（進階05、進階06、進階08 都是）——那裡的「該不該整合」沒有安全答案。
